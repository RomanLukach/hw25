const SELECTORS = {
    ANDROID: {
        WRONG_PASSWORD_ALERT: '*//android.view.ViewGroup[4]/android.widget.TextView[2]'
    },
...
class WrongPassAlert {
    ...
    static async text ():Promise<string> {
        ...
        return `${await $(SELECTORS.ANDROID.WRONG_PASSWORD_ALERT).getText()}`;
    }
}

export default WrongPassAlert;